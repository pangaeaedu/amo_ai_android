...
************************************/
public class G_th_pages_pages implements IJsonMapCreator
{
	@Override
	...
	private void func_2(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			...
			map1.put("properties", stack.peek());
			{
				...
				map1.put("account_hint", "กรุณากรอกหมายเลขบัญชี");
				map1.put("password", "");
				...
				map1.put("psw_hint", "กรุณากรอกรหัสผ่าน");
			}
			stack.pop();
			map1 = (Map<String, Object>) stack.peek();
		}
